...
class UriToClashConverter:
    ...
    def parse_ss(uri: str) -> Optional[Dict]:
        ...
        proxy = {
            ...
            "cipher": normalized_cipher, "password": password, "udp": True
        }
        if 'plugin' in params:
    ...
    def parse_ssr(uri: str) -> Optional[Dict]:
        try:
            ...
            proxy = {
                ...
                "type": "ssr", "server": server, "port": port, "cipher": method, "password": password,
                "obfs": obfs, "protocol": protocol,
    ...
    def parse_wireguard(uri: str) -> Optional[Dict]:
        ...
        proxy = {
            ...
            "public-key": params.get('publicKey', [''])[0], "udp": True
        }
